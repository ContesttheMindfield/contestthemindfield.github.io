...
&emsp;&emsp;Flesh and Blood's pitch and resource system proposes something unique: it simulates two people at their physical and tactical prime, fighting each other until one of them runs out of energy or blood.
<br>

![](101_Scar_for_a_Scar_Arif_Wijaya-scaled%20%281%29.jpg "Scar For a Scar")

Most decks in Flesh and Blood sit somewhere on a spectrum we'd loosely call midrange, though the word barely means anything once you actually apply it to this game. That's because of a single design choice sitting underneath everything else: almost every card in your hand is simultaneously your resource base, your offense, and your defense. There's no split between "the stuff that lets you play spells" and "the spells themselves" the way there is in Magic and most other card games. Each card is all of it at once, and it only becomes one of those things the moment you actually commit it, which means every card sitting in your hand is being evaluated for three completely different jobs, constantly, until you're forced to pick.
...
Despite doing so instinctively all along, a few months ago I got into a situation that forced me to address the question of who is the beatdown consciously for the first time in a Flesh and Blood game. I somehow found myself in the finals match of a Road to Nationals Event. I was playing [Verdance](#fab-card:verdance-thorn-of-the-rose) , my all-time favorite hero, against the other finalist, playing [Dash I/O](#fab-card:dash-IO). The standard plan against Dash is to fatigue her out: her aggression is balanced around the risk of fatiguing herself first, which usually shoehorses her as the beatdown and [Verdance](#fab-card:verdance-thorn-of-the-rose) the control deck by matchup theory alone.
...
His deck ran heavy on items to support that plan, which meant he couldn't block efficiently. Once he hit 16 [Life](#fab-icon:life) , I stopped considering value at all and started playing to end the game before he could. On his next turn I watched my [Life](#fab-icon:life) total diminish from full to barely nothing while holding a full grip of four. I came back with [Channel the Millennium Tree](#fab-card:channel-the-millennium-tree-red) into [Waning Moon](#fab-card:waning-moon) into [Felling of the Crown](#fab-card:felling-of-the-crown-red), dropping him to 3. It wasn't the safest or the most efficient use of those cards, I'd have gotten more out of them by simply blocking, but by then the only math that mattered was the one that ended the game. Any spell left in my subsequent hand would have finished him. As it happened, and somewhat ironically, I only had one.

[Storm Striders](#fab-card:storm-striders) into [Arcane Twining](#fab-card:arcane-twining-blue) into [Waning Moon](#fab-card:waning-moon) did the job at the last possible second.
...
Answering "who's the beatdown" well, turn after turn, isn't just a read on the [Life](#fab-icon:life) totals. It's a read on the cards themselves, and the best way of converting what your hero's intellect has granted you for the turn cycle, and ultimately into the whole game itself. You can't correctly decide whether to swing, block, or hold back if you don't already know what each card in your hand is actually worth in the first place.
