...
Most decks in Flesh and Blood sit somewhere on a spectrum we'd loosely call midrange, though the word barely means anything once you actually apply it to this game. That's because of a single design choice sitting underneath everything else: almost every card in your hand is simultaneously your resource [Resource](#fab-icon:resource) base, your offense [Power](#fab-icon:power), and your defense [Defense](#fab-icon:defense). There's no split between "the stuff that lets you play spells" and "the spells themselves" the way there is in Magic and most other card games. Each card is all of it at once, and it only becomes one of those things the moment you actually commit it, which means every card sitting in your hand is being evaluated for three completely different jobs, constantly, until you're forced to pick.
...
Answering "who's the beatdown" well, turn after turn, isn't just a read on the Life [Life](#fab-icon:life) totals. It's a read on the cards themselves, and the best way of converting what your hero's intellect [Intellect](#fab-icon:intellect) has granted you for the turn cycle, and ultimately into the whole game itself. You can't correctly decide whether to swing, block, or hold back if you don't already know what each card in your hand is actually worth in the first place.
